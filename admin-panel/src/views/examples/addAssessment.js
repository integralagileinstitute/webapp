...
class addAssessment extends Component {
  ...
  addQuestion = (e) => {
    ...
    if (e.target.dimension.value === "Dimension") {
      this.setState({ dimension_error: "Please Select a Dimension" });
      error = true;
    } else {
      this.setState({
        dimension_error: "",
    ...
    if (e.target.category.value === "Category") {
      this.setState({ category_error: "Please Select a Category" });
      error = true;
    } else {
      this.setState({
        category_error: "",
    ...
    if (e.target.competency.value === "Competency") {
      this.setState({ competency_error: "Please Select a Competency" });
      error = true;
    } else {
      this.setState({
        competency_error: "",
    ...
    if (e.target.type.value === "Type") {
      this.setState({ question_type_error: "Please Select a Type" });
      error = true;
    } else {
      this.setState({
        question_type_error: "",
    ...
    if (!e.target.text.value) {
      this.setState({ text_error: "Please add Question Text" });
      error = true;
    } else {
      this.setState({
        text_error: "",
